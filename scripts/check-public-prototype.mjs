...
async function main() {
  ...
  assert(outputText(pack).includes("total files: 29"), "npm dry-run did not report expected 29 package files (v0.3.5+ includes docs/whatsnew/v0.3.1.md through v0.3.5.md)");
