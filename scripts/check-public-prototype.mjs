...
async function main() {
  ...
  assert(outputText(pack).includes("total files: 30"), "npm dry-run did not report expected 30 package files (v0.3.6+ includes docs/whatsnew/v0.3.1.md through v0.3.6.md)");
