...
async function main() {
  ...
  assert(outputText(pack).includes("total files: 31"), "npm dry-run did not report expected 31 package files (v0.3.7+ includes docs/whatsnew/v0.3.1.md through v0.3.7.md)");
