...
async function main() {
  ...
  assert(outputText(pack).includes("total files: 33"), "npm dry-run did not report expected 33 package files (v0.3.9+ includes docs/whatsnew/v0.3.1.md through v0.3.9.md)");
