...
async function main() {
  ...
  assert(outputText(pack).includes("total files: 32"), "npm dry-run did not report expected 32 package files (v0.3.8+ includes docs/whatsnew/v0.3.1.md through v0.3.8.md)");
